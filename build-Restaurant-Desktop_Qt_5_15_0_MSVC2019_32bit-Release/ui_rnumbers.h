...
public:
    ...
    void setupUi(QDialog *RNumbers)
    {
        ...
        btnAccept->setMinimumSize(QSize(40, 40));
        btnAccept->setMaximumSize(QSize(40, 40));
        ...
        btnReject->setMinimumSize(QSize(40, 40));
        btnReject->setMaximumSize(QSize(40, 40));
        ...
        btnClear->setMinimumSize(QSize(40, 40));
        btnClear->setMaximumSize(QSize(40, 40));
