...
public:
    ...
    void setupUi(QDialog *PPrintPreview)
    {
        ...
        chCloseAfterPrint = new QCheckBox(widget);
        chCloseAfterPrint->setObjectName(QString::fromUtf8("chCloseAfterPrint"));

        horizontalLayout->addWidget(chCloseAfterPrint);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1204, 658));
    ...
    void retranslateUi(QDialog *PPrintPreview)
    {
        ...
        chCloseAfterPrint->setText(QCoreApplication::translate("PPrintPreview", "Close after print", nullptr));
