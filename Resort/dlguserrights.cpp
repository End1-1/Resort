...
void DlgUserRights::setup(QList<QVariant> &values)
{
    ...
    fTrackControl->addWidget(ui->chRoomChart, "Room char")
            ...
            .addWidget(ui->chInvCancelPrevDate, "Invoice cancelation before working date")
            .addWidget(ui->chInvoiceCancelWorkingDate, "Invoice cancelation on the working date")
            ...
            .addWidget(ui->chGuestReport, "Guest reports")
