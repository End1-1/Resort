...
public:
    ...
    void setupUi(QDialog *RFace)
    {
        ...
        frErr = new QFrame(widget_2);
        frErr->setObjectName(QString::fromUtf8("frErr"));
        frErr->setMinimumSize(QSize(50, 0));
        frErr->setStyleSheet(QString::fromUtf8("background-color:red;"));
        frErr->setFrameShape(QFrame::StyledPanel);
        frErr->setFrameShadow(QFrame::Raised);

        horizontalLayout_2->addWidget(frErr);
