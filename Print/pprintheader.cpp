...
PPrintHeader::PPrintHeader(PPrintScene *ps, const QString &headerText, int number) :
    Base()
{
    PTextRect *trHeader = new PTextRect(20, 20, 2000, 200, headerText, nullptr, QFont("Arial", 50));
    ...
    PTextRect *trInvoice = new PTextRect(20, trHeader->textHeight(), 2000, 80, inv, nullptr, QFont("Arial", 20));
