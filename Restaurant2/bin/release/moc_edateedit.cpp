...
#include "../../../../Resort2/Controls/edateedit.h"
...
void EDateEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        EDateEdit *_t = static_cast<EDateEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (EDateEdit::*_t)(const QDate & );
...
const QMetaObject EDateEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_EDateEdit.data,
      qt_meta_data_EDateEdit,  qt_static_metacall, nullptr, nullptr}
};
