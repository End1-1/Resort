...
#include "../../../../Resort2/Controls/ecolorlineedit.h"
...
void EColorLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        EColorLineEdit *_t = static_cast<EColorLineEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject EColorLineEdit::staticMetaObject = {
    { &EQLineEdit::staticMetaObject, qt_meta_stringdata_EColorLineEdit.data,
      qt_meta_data_EColorLineEdit,  qt_static_metacall, nullptr, nullptr}
};
