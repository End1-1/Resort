...
#include "../../../../Resort2/Restaurant2/rselecttable.h"
...
void RSelectTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RSelectTable *_t = static_cast<RSelectTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject RSelectTable::staticMetaObject = {
    { &BaseExtendedDialog::staticMetaObject, qt_meta_stringdata_RSelectTable.data,
      qt_meta_data_RSelectTable,  qt_static_metacall, nullptr, nullptr}
};
