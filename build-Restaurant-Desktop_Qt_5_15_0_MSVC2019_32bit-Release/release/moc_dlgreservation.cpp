...
#include <memory>
#include "../../Restaurant/dlgreservation.h"
...
void DlgReservation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DlgReservation *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DlgReservation::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseExtendedDialog::staticMetaObject>(),
    qt_meta_stringdata_DlgReservation.data,
    qt_meta_data_DlgReservation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
