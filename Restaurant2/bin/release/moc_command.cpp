...
#include "../../../../Resort2/Base/command.h"
...
QT_MOC_LITERAL(1, 8, 12), // "parseCommand"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7) // "command"

    },
    "Command\0parseCommand\0\0command"
};
...
void Command::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->parseCommand((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Command::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Command::parseCommand)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Command::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Command.data,
...
// SIGNAL 0
void Command::parseCommand(const QString & _t1)
{
