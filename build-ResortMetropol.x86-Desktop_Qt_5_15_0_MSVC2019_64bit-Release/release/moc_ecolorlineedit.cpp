...
QT_MOC_LITERAL(5, 47, 5) // "Field"

    },
    "EColorLineEdit\0doubleClicked\0\0"
    "colorChanged\0arg\0Field"
};
...
void EColorLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->colorChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (EColorLineEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EColorLineEdit::doubleClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void EColorLineEdit::doubleClicked()
{
