...
public:
    ...
    void setupUi(QDialog *RPaymentType)
    {
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/window.png"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem6 = new QListWidgetItem(lstData);
        __qlistwidgetitem6->setIcon(icon6);
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/balance.png"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem7 = new QListWidgetItem(lstData);
    ...
    void retranslateUi(QDialog *RPaymentType)
    {
        ...
        ___qlistwidgetitem6->setText(QCoreApplication::translate("RPaymentType", "Transfer to room", nullptr));
        QListWidgetItem *___qlistwidgetitem7 = lstData->item(7);
        ___qlistwidgetitem7->setText(QCoreApplication::translate("RPaymentType", "City ledger", nullptr));
