...
#include "../../../../Resort2/Controls/eqlineedit.h"
...
void EQLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        EQLineEdit *_t = static_cast<EQLineEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (EQLineEdit::*_t)(bool );
...
const QMetaObject EQLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_EQLineEdit.data,
      qt_meta_data_EQLineEdit,  qt_static_metacall, nullptr, nullptr}
};
