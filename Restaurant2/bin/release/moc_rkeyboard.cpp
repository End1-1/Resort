...
#include "../../../../Resort2/Restaurant2/rkeyboard.h"
...
void RKeyboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RKeyboard *_t = static_cast<RKeyboard *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (RKeyboard::*_t)(const QString & );
...
const QMetaObject RKeyboard::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RKeyboard.data,
      qt_meta_data_RKeyboard,  qt_static_metacall, nullptr, nullptr}
};
