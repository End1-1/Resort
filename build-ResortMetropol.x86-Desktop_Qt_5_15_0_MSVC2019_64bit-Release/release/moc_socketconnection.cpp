...
#include <memory>
#include "../../Server2/socketconnection.h"
...
QT_MOC_LITERAL(1, 17, 11), // "callHandler"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9), // "readyRead"
...
QT_MOC_LITERAL(7, 88, 3) // "err"
    ...
    "SocketConnection\0callHandler\0\0readyRead\0"
...
void SocketConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->callHandler((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SocketConnection::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketConnection::callHandler)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SocketConnection::callHandler(const QByteArray & _t1)
{
