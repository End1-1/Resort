...
#include "../../../../Resort2/Print/pprintpreview.h"
...
void PPrintPreview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PPrintPreview *_t = static_cast<PPrintPreview *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject PPrintPreview::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PPrintPreview.data,
      qt_meta_data_PPrintPreview,  qt_static_metacall, nullptr, nullptr}
};
