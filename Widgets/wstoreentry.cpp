...
void WStoreEntry::on_btnCalculate_clicked()
{
    ...
    for (int i = 0; i < drt.rowCount(); i++) {
        ...
        goodsList[drt.getValue(i, "f_material").toInt()].qty = goodsList[drt.getValue(i, "f_material").toInt()].qty + drt.getValue(i, "f_qty").toDouble();
        goodsList[drt.getValue(i, "f_material").toInt()].total = goodsList[drt.getValue(i, "f_material").toInt()].total + drt.getValue(i, "f_total").toDouble();
    }
    ...
    for (int i = 0; i < drt2.rowCount(); i++) {
        ...
        goodsList[drt2.getValue(i, "f_material").toInt()].qty = goodsList[drt2.getValue(i, "f_material").toInt()].qty + drt2.getValue(i, "f_qty").toDouble();
        goodsList[drt2.getValue(i, "f_material").toInt()].total = goodsList[drt2.getValue(i, "f_material").toInt()].total + drt2.getValue(i, "f_total").toDouble();
    }
