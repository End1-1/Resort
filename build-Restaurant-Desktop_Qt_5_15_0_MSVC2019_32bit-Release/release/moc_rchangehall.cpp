...
#include <memory>
#include "../../Restaurant/rchangehall.h"
...
QT_MOC_LITERAL(5, 50, 20) // "on_btnCancel_clicked"

    },
    "RChangeHall\0on_tblHall_clicked\0\0"
    "QModelIndex\0index\0on_btnCancel_clicked"
};
...
void RChangeHall::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RChangeHall *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject RChangeHall::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseExtendedDialog::staticMetaObject>(),
    qt_meta_stringdata_RChangeHall.data,
    qt_meta_data_RChangeHall,
    qt_static_metacall,
    nullptr,
    nullptr
} };
