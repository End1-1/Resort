...
void DlgExport::on_btnStart_clicked()
{
    ...
    DoubleDatabase sDb;
    sDb.setDatabase(ui->leHost->text(), ui->leDatabase->text(), ui->leUsername->text(), ui->lePassword->text(), 1);
    ...
    {
        DoubleDatabase dr10(sDb);
        dr10.open(true, false);
